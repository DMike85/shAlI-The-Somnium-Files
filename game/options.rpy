...
define config.name = _("shAlI The Somnium Files")
...
Investigad mientras celebráis el cumpleaños de nuestra querida Shali.{p}Sprites: Shali{p}Guión: Shali{p}Diseño de HUD: Mike{p}Programación: Mike y Silvia
""")
...
define config.save_directory = "shAlITheSomniumFiles-1693174892"
...
define config.layers = ['master', 'transient', 'screens', 'overlay','sprites']
